...
type TargetGroup struct {
	...
	*/
	...
	TargetHealthStates []types.Lb_TargetGroupTargetHealthState `json:"targetHealthStates,omitempty" yaml:"targetHealthStates,omitempty"`

	// Identifier of the VPC in which to create the target group. Required when `target_type` is `instance`, `ip` or `alb`. Does not apply when `target_type` is `lambda`.
	VpcId string `json:"vpcId,omitempty" yaml:"vpcId,omitempty"`

	// Target health requirements block. See target_group_health for more information.
	TargetGroupHealth types.Lb_TargetGroupTargetGroupHealth `json:"targetGroupHealth,omitempty" yaml:"targetGroupHealth,omitempty"`
	...
	TargetFailovers []types.Lb_TargetGroupTargetFailover `json:"targetFailovers,omitempty" yaml:"targetFailovers,omitempty"`
	...
	*/
	...
	Stickiness types.Lb_TargetGroupStickiness `json:"stickiness,omitempty" yaml:"stickiness,omitempty"`
	...
	HealthCheck types.Lb_TargetGroupHealthCheck `json:"healthCheck,omitempty" yaml:"healthCheck,omitempty"`
