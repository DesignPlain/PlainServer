...
type Listener struct {
	...
	DefaultActions []types.Lb_ListenerDefaultAction `json:"defaultActions,omitempty" yaml:"defaultActions,omitempty"`

	// The mutual authentication configuration information. Detailed below.
	MutualAuthentication types.Lb_ListenerMutualAuthentication `json:"mutualAuthentication,omitempty" yaml:"mutualAuthentication,omitempty"`
