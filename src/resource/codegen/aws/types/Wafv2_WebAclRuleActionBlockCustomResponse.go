...
type Wafv2_WebAclRuleActionBlockCustomResponse struct {
	...
	ResponseHeaders []Wafv2_WebAclRuleActionBlockCustomResponseResponseHeader `json:"responseHeaders,omitempty" yaml:"responseHeaders,omitempty"`
