...
type Wafv2_RuleGroupRuleStatementXssMatchStatementFieldToMatchJsonBody struct {
	...
	MatchPattern Wafv2_RuleGroupRuleStatementXssMatchStatementFieldToMatchJsonBodyMatchPattern `json:"matchPattern,omitempty" yaml:"matchPattern,omitempty"`
