...
type Lex_V2modelsIntentConfirmationSettingConfirmationConditional struct {
	...
	ConditionalBranches []Lex_V2modelsIntentConfirmationSettingConfirmationConditionalConditionalBranch `json:"conditionalBranches,omitempty" yaml:"conditionalBranches,omitempty"`
	...
	DefaultBranch Lex_V2modelsIntentConfirmationSettingConfirmationConditionalDefaultBranch `json:"defaultBranch,omitempty" yaml:"defaultBranch,omitempty"`
}
