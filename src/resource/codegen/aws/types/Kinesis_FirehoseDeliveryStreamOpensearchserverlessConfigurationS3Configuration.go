...
type Kinesis_FirehoseDeliveryStreamOpensearchserverlessConfigurationS3Configuration struct {
	...
	*/
	...
	CloudwatchLoggingOptions Kinesis_FirehoseDeliveryStreamOpensearchserverlessConfigurationS3ConfigurationCloudwatchLoggingOptions `json:"cloudwatchLoggingOptions,omitempty" yaml:"cloudwatchLoggingOptions,omitempty"`
