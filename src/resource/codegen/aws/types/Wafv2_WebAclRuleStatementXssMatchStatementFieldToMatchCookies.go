...
type Wafv2_WebAclRuleStatementXssMatchStatementFieldToMatchCookies struct {
	...
	MatchPatterns []Wafv2_WebAclRuleStatementXssMatchStatementFieldToMatchCookiesMatchPattern `json:"matchPatterns,omitempty" yaml:"matchPatterns,omitempty"`
