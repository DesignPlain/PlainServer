...
type Ec2_FleetOnDemandOptions struct {
	...
	CapacityReservationOptions Ec2_FleetOnDemandOptionsCapacityReservationOptions `json:"capacityReservationOptions,omitempty" yaml:"capacityReservationOptions,omitempty"`
