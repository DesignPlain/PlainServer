...
type Ssmincidents_ResponsePlanIncidentTemplate struct {
	...
	NotificationTargets []Ssmincidents_ResponsePlanIncidentTemplateNotificationTarget `json:"notificationTargets,omitempty" yaml:"notificationTargets,omitempty"`
}
