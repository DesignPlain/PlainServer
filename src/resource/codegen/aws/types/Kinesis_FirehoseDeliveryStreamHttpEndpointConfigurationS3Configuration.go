...
type Kinesis_FirehoseDeliveryStreamHttpEndpointConfigurationS3Configuration struct {
	...
	*/
	...
	CloudwatchLoggingOptions Kinesis_FirehoseDeliveryStreamHttpEndpointConfigurationS3ConfigurationCloudwatchLoggingOptions `json:"cloudwatchLoggingOptions,omitempty" yaml:"cloudwatchLoggingOptions,omitempty"`
