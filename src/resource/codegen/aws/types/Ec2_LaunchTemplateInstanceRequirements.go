...
type Ec2_LaunchTemplateInstanceRequirements struct {
	// Block describing the minimum and maximum number of accelerators (GPUs, FPGAs, or AWS Inferentia chips). Default is no minimum or maximum.
	AcceleratorCount Ec2_LaunchTemplateInstanceRequirementsAcceleratorCount `json:"acceleratorCount,omitempty" yaml:"acceleratorCount,omitempty"`
	...
	*/
	...
	AcceleratorTotalMemoryMib Ec2_LaunchTemplateInstanceRequirementsAcceleratorTotalMemoryMib `json:"acceleratorTotalMemoryMib,omitempty" yaml:"acceleratorTotalMemoryMib,omitempty"`
	...
	*/
	...
	BaselineEbsBandwidthMbps Ec2_LaunchTemplateInstanceRequirementsBaselineEbsBandwidthMbps `json:"baselineEbsBandwidthMbps,omitempty" yaml:"baselineEbsBandwidthMbps,omitempty"`
	...
	*/
	...
	TotalLocalStorageGb Ec2_LaunchTemplateInstanceRequirementsTotalLocalStorageGb `json:"totalLocalStorageGb,omitempty" yaml:"totalLocalStorageGb,omitempty"`
	...
	*/
	...
	MemoryGibPerVcpu Ec2_LaunchTemplateInstanceRequirementsMemoryGibPerVcpu `json:"memoryGibPerVcpu,omitempty" yaml:"memoryGibPerVcpu,omitempty"`

	// Block describing the minimum and maximum amount of network bandwidth, in gigabits per second (Gbps). Default is no minimum or maximum.
	NetworkBandwidthGbps Ec2_LaunchTemplateInstanceRequirementsNetworkBandwidthGbps `json:"networkBandwidthGbps,omitempty" yaml:"networkBandwidthGbps,omitempty"`
	...
	*/
	...
	VcpuCount Ec2_LaunchTemplateInstanceRequirementsVcpuCount `json:"vcpuCount,omitempty" yaml:"vcpuCount,omitempty"`
	...
	*/
	...
	MemoryMib Ec2_LaunchTemplateInstanceRequirementsMemoryMib `json:"memoryMib,omitempty" yaml:"memoryMib,omitempty"`

	// Block describing the minimum and maximum number of network interfaces. Default is no minimum or maximum.
	NetworkInterfaceCount Ec2_LaunchTemplateInstanceRequirementsNetworkInterfaceCount `json:"networkInterfaceCount,omitempty" yaml:"networkInterfaceCount,omitempty"`
