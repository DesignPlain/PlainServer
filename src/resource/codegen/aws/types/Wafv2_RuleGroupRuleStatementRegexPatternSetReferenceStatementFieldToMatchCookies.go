...
type Wafv2_RuleGroupRuleStatementRegexPatternSetReferenceStatementFieldToMatchCookies struct {
	...
	MatchPatterns []Wafv2_RuleGroupRuleStatementRegexPatternSetReferenceStatementFieldToMatchCookiesMatchPattern `json:"matchPatterns,omitempty" yaml:"matchPatterns,omitempty"`
