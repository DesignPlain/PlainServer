...
type Wafv2_WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchHeader struct {
	...
	MatchPattern Wafv2_WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchHeaderMatchPattern `json:"matchPattern,omitempty" yaml:"matchPattern,omitempty"`
}
