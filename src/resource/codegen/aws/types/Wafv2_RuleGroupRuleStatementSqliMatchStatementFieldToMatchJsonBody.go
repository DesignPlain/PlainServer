...
type Wafv2_RuleGroupRuleStatementSqliMatchStatementFieldToMatchJsonBody struct {
	...
	MatchPattern Wafv2_RuleGroupRuleStatementSqliMatchStatementFieldToMatchJsonBodyMatchPattern `json:"matchPattern,omitempty" yaml:"matchPattern,omitempty"`
