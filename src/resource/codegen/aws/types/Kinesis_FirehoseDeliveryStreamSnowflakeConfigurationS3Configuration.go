...
type Kinesis_FirehoseDeliveryStreamSnowflakeConfigurationS3Configuration struct {
	...
	*/
	...
	CloudwatchLoggingOptions Kinesis_FirehoseDeliveryStreamSnowflakeConfigurationS3ConfigurationCloudwatchLoggingOptions `json:"cloudwatchLoggingOptions,omitempty" yaml:"cloudwatchLoggingOptions,omitempty"`
