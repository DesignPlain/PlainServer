...
type Wafv2_WebAclRuleStatementRegexMatchStatementFieldToMatchCookies struct {
	...
	MatchPatterns []Wafv2_WebAclRuleStatementRegexMatchStatementFieldToMatchCookiesMatchPattern `json:"matchPatterns,omitempty" yaml:"matchPatterns,omitempty"`
