...
type Lex_V2modelsIntentConfirmationSettingCodeHook struct {
	...
	PostCodeHookSpecification Lex_V2modelsIntentConfirmationSettingCodeHookPostCodeHookSpecification `json:"postCodeHookSpecification,omitempty" yaml:"postCodeHookSpecification,omitempty"`
}
