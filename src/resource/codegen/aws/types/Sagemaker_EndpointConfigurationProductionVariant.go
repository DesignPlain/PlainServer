...
type Sagemaker_EndpointConfigurationProductionVariant struct {
	...
	RoutingConfigs []Sagemaker_EndpointConfigurationProductionVariantRoutingConfig `json:"routingConfigs,omitempty" yaml:"routingConfigs,omitempty"`
	...
	ServerlessConfig Sagemaker_EndpointConfigurationProductionVariantServerlessConfig `json:"serverlessConfig,omitempty" yaml:"serverlessConfig,omitempty"`
	...
	CoreDumpConfig Sagemaker_EndpointConfigurationProductionVariantCoreDumpConfig `json:"coreDumpConfig,omitempty" yaml:"coreDumpConfig,omitempty"`
}
