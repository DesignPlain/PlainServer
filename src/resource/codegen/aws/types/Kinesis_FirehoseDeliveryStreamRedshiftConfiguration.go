...
type Kinesis_FirehoseDeliveryStreamRedshiftConfiguration struct {
	...
	*/
	...
	//
	SecretsManagerConfiguration Kinesis_FirehoseDeliveryStreamRedshiftConfigurationSecretsManagerConfiguration `json:"secretsManagerConfiguration,omitempty" yaml:"secretsManagerConfiguration,omitempty"`
