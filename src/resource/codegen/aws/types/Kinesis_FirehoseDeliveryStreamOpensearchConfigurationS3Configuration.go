...
type Kinesis_FirehoseDeliveryStreamOpensearchConfigurationS3Configuration struct {
	...
	*/
	...
	CloudwatchLoggingOptions Kinesis_FirehoseDeliveryStreamOpensearchConfigurationS3ConfigurationCloudwatchLoggingOptions `json:"cloudwatchLoggingOptions,omitempty" yaml:"cloudwatchLoggingOptions,omitempty"`
