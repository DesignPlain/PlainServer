...
type Wafv2_WebAclDefaultActionBlockCustomResponse struct {
	...
	ResponseHeaders []Wafv2_WebAclDefaultActionBlockCustomResponseResponseHeader `json:"responseHeaders,omitempty" yaml:"responseHeaders,omitempty"`
}
