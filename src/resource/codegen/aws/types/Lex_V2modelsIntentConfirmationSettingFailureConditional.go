...
type Lex_V2modelsIntentConfirmationSettingFailureConditional struct {
	...
	ConditionalBranches []Lex_V2modelsIntentConfirmationSettingFailureConditionalConditionalBranch `json:"conditionalBranches,omitempty" yaml:"conditionalBranches,omitempty"`
	...
	DefaultBranch Lex_V2modelsIntentConfirmationSettingFailureConditionalDefaultBranch `json:"defaultBranch,omitempty" yaml:"defaultBranch,omitempty"`
}
