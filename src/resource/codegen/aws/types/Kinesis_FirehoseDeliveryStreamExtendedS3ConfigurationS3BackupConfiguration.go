...
type Kinesis_FirehoseDeliveryStreamExtendedS3ConfigurationS3BackupConfiguration struct {
	//
	...
	*/
	...
	//
	CloudwatchLoggingOptions Kinesis_FirehoseDeliveryStreamExtendedS3ConfigurationS3BackupConfigurationCloudwatchLoggingOptions `json:"cloudwatchLoggingOptions,omitempty" yaml:"cloudwatchLoggingOptions,omitempty"`
}
