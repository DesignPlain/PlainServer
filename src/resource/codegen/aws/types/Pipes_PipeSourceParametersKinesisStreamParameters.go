...
type Pipes_PipeSourceParametersKinesisStreamParameters struct {
	...
	DeadLetterConfig Pipes_PipeSourceParametersKinesisStreamParametersDeadLetterConfig `json:"deadLetterConfig,omitempty" yaml:"deadLetterConfig,omitempty"`
