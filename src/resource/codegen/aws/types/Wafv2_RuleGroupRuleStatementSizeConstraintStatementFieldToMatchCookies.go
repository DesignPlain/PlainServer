...
type Wafv2_RuleGroupRuleStatementSizeConstraintStatementFieldToMatchCookies struct {
	...
	MatchPatterns []Wafv2_RuleGroupRuleStatementSizeConstraintStatementFieldToMatchCookiesMatchPattern `json:"matchPatterns,omitempty" yaml:"matchPatterns,omitempty"`
