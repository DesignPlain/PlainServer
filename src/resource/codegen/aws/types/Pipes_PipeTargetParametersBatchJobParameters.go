...
type Pipes_PipeTargetParametersBatchJobParameters struct {
	...
	RetryStrategy Pipes_PipeTargetParametersBatchJobParametersRetryStrategy `json:"retryStrategy,omitempty" yaml:"retryStrategy,omitempty"`
	...
	ArrayProperties Pipes_PipeTargetParametersBatchJobParametersArrayProperties `json:"arrayProperties,omitempty" yaml:"arrayProperties,omitempty"`

	// The overrides that are sent to a container. Detailed below.
	ContainerOverrides Pipes_PipeTargetParametersBatchJobParametersContainerOverrides `json:"containerOverrides,omitempty" yaml:"containerOverrides,omitempty"`
	...
	DependsOns []Pipes_PipeTargetParametersBatchJobParametersDependsOn `json:"dependsOns,omitempty" yaml:"dependsOns,omitempty"`
}
