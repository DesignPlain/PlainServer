...
type Batch_getSchedulingPolicyFairSharePolicy struct {
	...
	ShareDistributions []Batch_getSchedulingPolicyFairSharePolicyShareDistribution `json:"shareDistributions,omitempty" yaml:"shareDistributions,omitempty"`
