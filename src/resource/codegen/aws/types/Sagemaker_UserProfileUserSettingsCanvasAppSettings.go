...
type Sagemaker_UserProfileUserSettingsCanvasAppSettings struct {
	...
	//
	GenerativeAiSettings Sagemaker_UserProfileUserSettingsCanvasAppSettingsGenerativeAiSettings `json:"generativeAiSettings,omitempty" yaml:"generativeAiSettings,omitempty"`
}
