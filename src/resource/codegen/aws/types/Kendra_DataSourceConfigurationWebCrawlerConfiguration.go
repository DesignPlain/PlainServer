...
type Kendra_DataSourceConfigurationWebCrawlerConfiguration struct {
	...
	ProxyConfiguration Kendra_DataSourceConfigurationWebCrawlerConfigurationProxyConfiguration `json:"proxyConfiguration,omitempty" yaml:"proxyConfiguration,omitempty"`

	// A list of regular expression patterns to exclude certain URLs to crawl. URLs that match the patterns are excluded from the index. URLs that don't match the patterns are included in the index. If a URL matches both an inclusion and exclusion pattern, the exclusion pattern takes precedence and the URL file isn't included in the index. Array Members: Minimum number of `0` items. Maximum number of `100` items. Length Constraints: Minimum length of `1`. Maximum length of `150`.
	UrlExclusionPatterns []string `json:"urlExclusionPatterns,omitempty" yaml:"urlExclusionPatterns,omitempty"`
	...
	CrawlDepth int `json:"crawlDepth,omitempty" yaml:"crawlDepth,omitempty"`
	...
	MaxUrlsPerMinuteCrawlRate int `json:"maxUrlsPerMinuteCrawlRate,omitempty" yaml:"maxUrlsPerMinuteCrawlRate,omitempty"`
	...
	MaxLinksPerPage int `json:"maxLinksPerPage,omitempty" yaml:"maxLinksPerPage,omitempty"`

	// A list of regular expression patterns to include certain URLs to crawl. URLs that match the patterns are included in the index. URLs that don't match the patterns are excluded from the index. If a URL matches both an inclusion and exclusion pattern, the exclusion pattern takes precedence and the URL file isn't included in the index. Array Members: Minimum number of `0` items. Maximum number of `100` items. Length Constraints: Minimum length of `1`. Maximum length of `150`.
	UrlInclusionPatterns []string `json:"urlInclusionPatterns,omitempty" yaml:"urlInclusionPatterns,omitempty"`
	...
	Urls Kendra_DataSourceConfigurationWebCrawlerConfigurationUrls `json:"urls,omitempty" yaml:"urls,omitempty"`
	...
	AuthenticationConfiguration Kendra_DataSourceConfigurationWebCrawlerConfigurationAuthenticationConfiguration `json:"authenticationConfiguration,omitempty" yaml:"authenticationConfiguration,omitempty"`
	...
	MaxContentSizePerPageInMegaBytes float64 `json:"maxContentSizePerPageInMegaBytes,omitempty" yaml:"maxContentSizePerPageInMegaBytes,omitempty"`
}
