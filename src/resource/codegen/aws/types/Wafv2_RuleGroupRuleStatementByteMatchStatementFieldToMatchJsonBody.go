...
type Wafv2_RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBody struct {
	...
	MatchPattern Wafv2_RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBodyMatchPattern `json:"matchPattern,omitempty" yaml:"matchPattern,omitempty"`
