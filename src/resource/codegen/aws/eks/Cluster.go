...
type Cluster struct {
	...
	*/
	...
	BootstrapSelfManagedAddons bool `json:"bootstrapSelfManagedAddons,omitempty" yaml:"bootstrapSelfManagedAddons,omitempty"`
	...
	UpgradePolicy types.Eks_ClusterUpgradePolicy `json:"upgradePolicy,omitempty" yaml:"upgradePolicy,omitempty"`
