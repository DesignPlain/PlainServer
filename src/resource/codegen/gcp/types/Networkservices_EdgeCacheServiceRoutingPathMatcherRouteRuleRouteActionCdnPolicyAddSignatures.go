...
type Networkservices_EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicyAddSignatures struct {
	/*
	...
	*/
	CopiedParameters []string `json:"copiedParameters,omitempty" yaml:"copiedParameters,omitempty"`
	...
	*/
	Keyset string `json:"keyset,omitempty" yaml:"keyset,omitempty"`
	...
	*/
	TokenQueryParameter string `json:"tokenQueryParameter,omitempty" yaml:"tokenQueryParameter,omitempty"`
