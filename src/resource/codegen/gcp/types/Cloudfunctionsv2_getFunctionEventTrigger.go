...
type Cloudfunctionsv2_getFunctionEventTrigger struct {
	...
	*/
	...
	EventFilters []Cloudfunctionsv2_getFunctionEventTriggerEventFilter `json:"eventFilters,omitempty" yaml:"eventFilters,omitempty"`
