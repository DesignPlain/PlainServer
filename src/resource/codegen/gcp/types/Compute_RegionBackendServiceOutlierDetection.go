...
type Compute_RegionBackendServiceOutlierDetection struct {
	/*
	...
	*/
	BaseEjectionTime Compute_RegionBackendServiceOutlierDetectionBaseEjectionTime `json:"baseEjectionTime,omitempty" yaml:"baseEjectionTime,omitempty"`
	...
	*/
	...
	/*
	   ...
	   Structure is documented below.
	*/
	Interval Compute_RegionBackendServiceOutlierDetectionInterval `json:"interval,omitempty" yaml:"interval,omitempty"`
