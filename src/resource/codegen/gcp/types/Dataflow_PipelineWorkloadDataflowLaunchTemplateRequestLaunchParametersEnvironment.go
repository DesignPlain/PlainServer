...
type Dataflow_PipelineWorkloadDataflowLaunchTemplateRequestLaunchParametersEnvironment struct {
	...
	BypassTempDirValidation bool `json:"bypassTempDirValidation,omitempty" yaml:"bypassTempDirValidation,omitempty"`
