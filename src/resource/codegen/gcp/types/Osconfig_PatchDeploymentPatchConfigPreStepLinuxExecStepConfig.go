...
type Osconfig_PatchDeploymentPatchConfigPreStepLinuxExecStepConfig struct {
	...
	*/
	GcsObject Osconfig_PatchDeploymentPatchConfigPreStepLinuxExecStepConfigGcsObject `json:"gcsObject,omitempty" yaml:"gcsObject,omitempty"`
