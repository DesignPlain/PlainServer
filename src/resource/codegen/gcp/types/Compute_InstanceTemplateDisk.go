...
type Compute_InstanceTemplateDisk struct {
	/*
	...
	*/
	...
	/*
	   ...
	   documented below.
	*/
	SourceImageEncryptionKey Compute_InstanceTemplateDiskSourceImageEncryptionKey `json:"sourceImageEncryptionKey,omitempty" yaml:"sourceImageEncryptionKey,omitempty"`
	...
	/*
	   ...
	   documented below.
	*/
	SourceSnapshotEncryptionKey Compute_InstanceTemplateDiskSourceSnapshotEncryptionKey `json:"sourceSnapshotEncryptionKey,omitempty" yaml:"sourceSnapshotEncryptionKey,omitempty"`
	...
	*/
	DiskEncryptionKey Compute_InstanceTemplateDiskDiskEncryptionKey `json:"diskEncryptionKey,omitempty" yaml:"diskEncryptionKey,omitempty"`
