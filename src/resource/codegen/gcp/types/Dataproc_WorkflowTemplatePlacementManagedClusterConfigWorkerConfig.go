...
type Dataproc_WorkflowTemplatePlacementManagedClusterConfigWorkerConfig struct {
	// Disk option config settings.
	DiskConfig Dataproc_WorkflowTemplatePlacementManagedClusterConfigWorkerConfigDiskConfig `json:"diskConfig,omitempty" yaml:"diskConfig,omitempty"`
	...
	Accelerators []Dataproc_WorkflowTemplatePlacementManagedClusterConfigWorkerConfigAccelerator `json:"accelerators,omitempty" yaml:"accelerators,omitempty"`
	...
	ManagedGroupConfigs []Dataproc_WorkflowTemplatePlacementManagedClusterConfigWorkerConfigManagedGroupConfig `json:"managedGroupConfigs,omitempty" yaml:"managedGroupConfigs,omitempty"`
