...
type Pubsub_getSubscriptionCloudStorageConfig struct {
	...
	*/
	...
	AvroConfigs []Pubsub_getSubscriptionCloudStorageConfigAvroConfig `json:"avroConfigs,omitempty" yaml:"avroConfigs,omitempty"`
