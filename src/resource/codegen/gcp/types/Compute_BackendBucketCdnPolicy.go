...
type Compute_BackendBucketCdnPolicy struct {
	/*
	...
	*/
	BypassCacheOnRequestHeaders []Compute_BackendBucketCdnPolicyBypassCacheOnRequestHeader `json:"bypassCacheOnRequestHeaders,omitempty" yaml:"bypassCacheOnRequestHeaders,omitempty"`

	/*
	   The CacheKeyPolicy for this CdnPolicy.
	   Structure is documented below.
	*/
	CacheKeyPolicy Compute_BackendBucketCdnPolicyCacheKeyPolicy `json:"cacheKeyPolicy,omitempty" yaml:"cacheKeyPolicy,omitempty"`
	...
	*/
	...
	/*
	   ...
	   Structure is documented below.
	*/
	NegativeCachingPolicies []Compute_BackendBucketCdnPolicyNegativeCachingPolicy `json:"negativeCachingPolicies,omitempty" yaml:"negativeCachingPolicies,omitempty"`
