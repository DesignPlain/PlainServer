...
type Compute_InstanceFromTemplateScheduling struct {
	// Specifies node affinities or anti-affinities to determine which sole-tenant nodes your instances and managed instance groups will use as host systems.
	NodeAffinities []Compute_InstanceFromTemplateSchedulingNodeAffinity `json:"nodeAffinities,omitempty" yaml:"nodeAffinities,omitempty"`
	...
	MaxRunDuration Compute_InstanceFromTemplateSchedulingMaxRunDuration `json:"maxRunDuration,omitempty" yaml:"maxRunDuration,omitempty"`
	...
	/*
	   Specifies the maximum amount of time a Local Ssd Vm should wait while
	     ...
	     hour.
	*/
	LocalSsdRecoveryTimeout Compute_InstanceFromTemplateSchedulingLocalSsdRecoveryTimeout `json:"localSsdRecoveryTimeout,omitempty" yaml:"localSsdRecoveryTimeout,omitempty"`
}
