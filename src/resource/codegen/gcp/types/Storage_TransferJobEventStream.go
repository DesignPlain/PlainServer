...
type Storage_TransferJobEventStream struct {
	...
	EventStreamExpirationTime string `json:"eventStreamExpirationTime,omitempty" yaml:"eventStreamExpirationTime,omitempty"`
	...
	EventStreamStartTime string `json:"eventStreamStartTime,omitempty" yaml:"eventStreamStartTime,omitempty"`
