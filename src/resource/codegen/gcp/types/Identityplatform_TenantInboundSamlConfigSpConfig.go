...
type Identityplatform_TenantInboundSamlConfigSpConfig struct {
	...
	*/
	SpCertificates []Identityplatform_TenantInboundSamlConfigSpConfigSpCertificate `json:"spCertificates,omitempty" yaml:"spCertificates,omitempty"`
