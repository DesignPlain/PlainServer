...
type Vertex_getAiIndexMetadataConfig struct {
	/*
	...
	*/
	...
	AlgorithmConfigs []Vertex_getAiIndexMetadataConfigAlgorithmConfig `json:"algorithmConfigs,omitempty" yaml:"algorithmConfigs,omitempty"`
