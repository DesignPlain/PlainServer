...
type Accesscontextmanager_ServicePerimeterEgressPolicyEgressFrom struct {
	/*
	...
	*/
	Sources []Accesscontextmanager_ServicePerimeterEgressPolicyEgressFromSource `json:"sources,omitempty" yaml:"sources,omitempty"`
