...
type Compute_getBackendServiceCdnPolicy struct {
	// The CacheKeyPolicy for this CdnPolicy.
	CacheKeyPolicies []Compute_getBackendServiceCdnPolicyCacheKeyPolicy `json:"cacheKeyPolicies,omitempty" yaml:"cacheKeyPolicies,omitempty"`
	...
	*/
	NegativeCachingPolicies []Compute_getBackendServiceCdnPolicyNegativeCachingPolicy `json:"negativeCachingPolicies,omitempty" yaml:"negativeCachingPolicies,omitempty"`
	...
	*/
	BypassCacheOnRequestHeaders []Compute_getBackendServiceCdnPolicyBypassCacheOnRequestHeader `json:"bypassCacheOnRequestHeaders,omitempty" yaml:"bypassCacheOnRequestHeaders,omitempty"`
