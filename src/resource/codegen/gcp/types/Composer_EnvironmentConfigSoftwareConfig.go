...
type Composer_EnvironmentConfigSoftwareConfig struct {
	...
	CloudDataLineageIntegration Composer_EnvironmentConfigSoftwareConfigCloudDataLineageIntegration `json:"cloudDataLineageIntegration,omitempty" yaml:"cloudDataLineageIntegration,omitempty"`
