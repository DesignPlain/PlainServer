...
type Accesscontextmanager_AccessLevelBasicConditionDevicePolicy struct {
	/*
	...
	*/
	OsConstraints []Accesscontextmanager_AccessLevelBasicConditionDevicePolicyOsConstraint `json:"osConstraints,omitempty" yaml:"osConstraints,omitempty"`
