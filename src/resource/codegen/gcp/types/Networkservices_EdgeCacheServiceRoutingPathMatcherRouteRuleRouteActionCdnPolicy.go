...
type Networkservices_EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicy struct {
	/*
	...
	*/
	SignedRequestMaximumExpirationTtl string `json:"signedRequestMaximumExpirationTtl,omitempty" yaml:"signedRequestMaximumExpirationTtl,omitempty"`
	...
	*/
	SignedRequestMode string `json:"signedRequestMode,omitempty" yaml:"signedRequestMode,omitempty"`
	...
	*/
	NegativeCachingPolicy map[string]string `json:"negativeCachingPolicy,omitempty" yaml:"negativeCachingPolicy,omitempty"`
	...
	/*
	   ...
	   A duration in seconds terminated by 's'. Example: "3s".
	*/
	ClientTtl string `json:"clientTtl,omitempty" yaml:"clientTtl,omitempty"`
	...
	*/
	...
	SignedRequestKeyset string `json:"signedRequestKeyset,omitempty" yaml:"signedRequestKeyset,omitempty"`
	...
	*/
	SignedTokenOptions Networkservices_EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicySignedTokenOptions `json:"signedTokenOptions,omitempty" yaml:"signedTokenOptions,omitempty"`
	...
	/*
	   ...
	   Structure is documented below.
	*/
	AddSignatures Networkservices_EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicyAddSignatures `json:"addSignatures,omitempty" yaml:"addSignatures,omitempty"`

	/*
	   Defines the request parameters that contribute to the cache key.
	   Structure is documented below.
	*/
	CacheKeyPolicy Networkservices_EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicyCacheKeyPolicy `json:"cacheKeyPolicy,omitempty" yaml:"cacheKeyPolicy,omitempty"`
