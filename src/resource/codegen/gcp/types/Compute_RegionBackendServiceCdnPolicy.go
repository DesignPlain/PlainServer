...
type Compute_RegionBackendServiceCdnPolicy struct {
	...
	*/
	NegativeCachingPolicies []Compute_RegionBackendServiceCdnPolicyNegativeCachingPolicy `json:"negativeCachingPolicies,omitempty" yaml:"negativeCachingPolicies,omitempty"`
	...
	*/
	...
	/*
	   ...
	   Structure is documented below.
	*/
	CacheKeyPolicy Compute_RegionBackendServiceCdnPolicyCacheKeyPolicy `json:"cacheKeyPolicy,omitempty" yaml:"cacheKeyPolicy,omitempty"`
