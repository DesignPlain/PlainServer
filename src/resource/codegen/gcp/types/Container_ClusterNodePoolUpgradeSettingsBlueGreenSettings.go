...
type Container_ClusterNodePoolUpgradeSettingsBlueGreenSettings struct {
	...
	StandardRolloutPolicy Container_ClusterNodePoolUpgradeSettingsBlueGreenSettingsStandardRolloutPolicy `json:"standardRolloutPolicy,omitempty" yaml:"standardRolloutPolicy,omitempty"`
}
