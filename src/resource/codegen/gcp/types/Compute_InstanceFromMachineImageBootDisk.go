...
type Compute_InstanceFromMachineImageBootDisk struct {
	...
	InitializeParams Compute_InstanceFromMachineImageBootDiskInitializeParams `json:"initializeParams,omitempty" yaml:"initializeParams,omitempty"`
}
