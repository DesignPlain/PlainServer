...
type Billing_BudgetBudgetFilter struct {
	/*
	...
	*/
	CustomPeriod Billing_BudgetBudgetFilterCustomPeriod `json:"customPeriod,omitempty" yaml:"customPeriod,omitempty"`
	...
	*/
	ResourceAncestors []string `json:"resourceAncestors,omitempty" yaml:"resourceAncestors,omitempty"`
	...
	*/
	Subaccounts []string `json:"subaccounts,omitempty" yaml:"subaccounts,omitempty"`
	...
	*/
	...
	/*
	   ...
	   --Note:-- If the field has a value in the config and needs to be removed, the field has to be an emtpy array in the config.
	*/
	CreditTypes []string `json:"creditTypes,omitempty" yaml:"creditTypes,omitempty"`
	...
	*/
	CreditTypesTreatment string `json:"creditTypesTreatment,omitempty" yaml:"creditTypesTreatment,omitempty"`
