...
type Monitoring_AlertPolicyConditionConditionThresholdDenominatorAggregation struct {
	/*
	...
	*/
	AlignmentPeriod string `json:"alignmentPeriod,omitempty" yaml:"alignmentPeriod,omitempty"`
	...
	*/
	CrossSeriesReducer string `json:"crossSeriesReducer,omitempty" yaml:"crossSeriesReducer,omitempty"`
	...
	/*
	   ...
	   ignored.
	*/
	GroupByFields []string `json:"groupByFields,omitempty" yaml:"groupByFields,omitempty"`
	...
	*/
	PerSeriesAligner string `json:"perSeriesAligner,omitempty" yaml:"perSeriesAligner,omitempty"`
}
