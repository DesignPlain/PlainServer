...
type Compute_URLMapPathMatcherRouteRuleMatchRuleHeaderMatch struct {
	/*
	...
	*/
	RangeMatch Compute_URLMapPathMatcherRouteRuleMatchRuleHeaderMatchRangeMatch `json:"rangeMatch,omitempty" yaml:"rangeMatch,omitempty"`
}
