...
type Sql_getDatabaseInstancesInstanceSettingBackupConfiguration struct {
	...
	//
	BackupRetentionSettings []Sql_getDatabaseInstancesInstanceSettingBackupConfigurationBackupRetentionSetting `json:"backupRetentionSettings,omitempty" yaml:"backupRetentionSettings,omitempty"`
