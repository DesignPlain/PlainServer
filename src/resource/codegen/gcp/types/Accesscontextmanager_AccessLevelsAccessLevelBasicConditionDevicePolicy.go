...
type Accesscontextmanager_AccessLevelsAccessLevelBasicConditionDevicePolicy struct {
	/*
	...
	*/
	OsConstraints []Accesscontextmanager_AccessLevelsAccessLevelBasicConditionDevicePolicyOsConstraint `json:"osConstraints,omitempty" yaml:"osConstraints,omitempty"`
