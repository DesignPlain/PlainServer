...
type RegionSecurityPolicyRule struct {
	...
	*/
	Match types.Compute_RegionSecurityPolicyRuleMatch `json:"match,omitempty" yaml:"match,omitempty"`
	...
	*/
	...
	/*
	   ...
	   Structure is documented below.
	*/
	NetworkMatch types.Compute_RegionSecurityPolicyRuleNetworkMatch `json:"networkMatch,omitempty" yaml:"networkMatch,omitempty"`
