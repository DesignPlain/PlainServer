...
type NetworkFirewallPolicyRule struct {
	...
	TargetSecureTags []types.Compute_NetworkFirewallPolicyRuleTargetSecureTag `json:"targetSecureTags,omitempty" yaml:"targetSecureTags,omitempty"`
	...
	Match types.Compute_NetworkFirewallPolicyRuleMatch `json:"match,omitempty" yaml:"match,omitempty"`
