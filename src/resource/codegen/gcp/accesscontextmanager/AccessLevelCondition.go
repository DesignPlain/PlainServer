...
type AccessLevelCondition struct {
	...
	*/
	VpcNetworkSources []types.Accesscontextmanager_AccessLevelConditionVpcNetworkSource `json:"vpcNetworkSources,omitempty" yaml:"vpcNetworkSources,omitempty"`
	...
	*/
	...
	/*
	   ...
	   Structure is documented below.
	*/
	DevicePolicy types.Accesscontextmanager_AccessLevelConditionDevicePolicy `json:"devicePolicy,omitempty" yaml:"devicePolicy,omitempty"`
