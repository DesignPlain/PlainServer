...
type Composer_getEnvironmentConfigPrivateEnvironmentConfig struct {
	// The CIDR block from which IP range in tenant project will be reserved for Cloud SQL. Needs to be disjoint from web_server_ipv4_cidr_block.
	CloudSqlIpv4CidrBlock string `json:"cloudSqlIpv4CidrBlock,omitempty" yaml:"cloudSqlIpv4CidrBlock,omitempty"`
	...
	EnablePrivatelyUsedPublicIps bool `json:"enablePrivatelyUsedPublicIps,omitempty" yaml:"enablePrivatelyUsedPublicIps,omitempty"`
	...
	WebServerIpv4CidrBlock string `json:"webServerIpv4CidrBlock,omitempty" yaml:"webServerIpv4CidrBlock,omitempty"`
	...
	CloudComposerConnectionSubnetwork string `json:"cloudComposerConnectionSubnetwork,omitempty" yaml:"cloudComposerConnectionSubnetwork,omitempty"`
	...
	CloudComposerNetworkIpv4CidrBlock string `json:"cloudComposerNetworkIpv4CidrBlock,omitempty" yaml:"cloudComposerNetworkIpv4CidrBlock,omitempty"`
}
