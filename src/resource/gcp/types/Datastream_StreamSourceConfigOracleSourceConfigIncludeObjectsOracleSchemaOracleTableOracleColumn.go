...
type Datastream_StreamSourceConfigOracleSourceConfigIncludeObjectsOracleSchemaOracleTableOracleColumn struct {
	/*
	   (Output)
	...
	*/
	...
	/*
	   ...
	   https://docs.oracle.com/en/database/oracle/oracle-database/21/sqlrf/Data-html
	*/
