...
type Compute_RegionBackendServiceCircuitBreakers struct {
	/*
	...
	*/
	ConnectTimeout Compute_RegionBackendServiceCircuitBreakersConnectTimeout `json:"connectTimeout,omitempty" yaml:"connectTimeout,omitempty"`
