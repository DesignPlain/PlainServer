...
type Accesscontextmanager_ServicePerimeterSpecEgressPolicyEgressFrom struct {
	/*
	...
	*/
	Sources []Accesscontextmanager_ServicePerimeterSpecEgressPolicyEgressFromSource `json:"sources,omitempty" yaml:"sources,omitempty"`
