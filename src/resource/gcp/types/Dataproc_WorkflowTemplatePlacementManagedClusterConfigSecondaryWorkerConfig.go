...
type Dataproc_WorkflowTemplatePlacementManagedClusterConfigSecondaryWorkerConfig struct {
	...
	ManagedGroupConfigs []Dataproc_WorkflowTemplatePlacementManagedClusterConfigSecondaryWorkerConfigManagedGroupConfig `json:"managedGroupConfigs,omitempty" yaml:"managedGroupConfigs,omitempty"`
	...
	Accelerators []Dataproc_WorkflowTemplatePlacementManagedClusterConfigSecondaryWorkerConfigAccelerator `json:"accelerators,omitempty" yaml:"accelerators,omitempty"`

	// Disk option config settings.
	DiskConfig Dataproc_WorkflowTemplatePlacementManagedClusterConfigSecondaryWorkerConfigDiskConfig `json:"diskConfig,omitempty" yaml:"diskConfig,omitempty"`
