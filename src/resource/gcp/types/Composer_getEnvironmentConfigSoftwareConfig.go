...
type Composer_getEnvironmentConfigSoftwareConfig struct {
	...
	SchedulerCount int `json:"schedulerCount,omitempty" yaml:"schedulerCount,omitempty"`

	// Should be either 'ENABLED' or 'DISABLED'. Defaults to 'ENABLED'. Used in Composer 3.
	WebServerPluginsMode string `json:"webServerPluginsMode,omitempty" yaml:"webServerPluginsMode,omitempty"`
	...
	AirflowConfigOverrides map[string]string `json:"airflowConfigOverrides,omitempty" yaml:"airflowConfigOverrides,omitempty"`
	...
	CloudDataLineageIntegrations []Composer_getEnvironmentConfigSoftwareConfigCloudDataLineageIntegration `json:"cloudDataLineageIntegrations,omitempty" yaml:"cloudDataLineageIntegrations,omitempty"`
	...
	PypiPackages map[string]string `json:"pypiPackages,omitempty" yaml:"pypiPackages,omitempty"`
}
