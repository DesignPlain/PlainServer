...
type Accesscontextmanager_ServicePerimeterStatusEgressPolicyEgressFrom struct {
	/*
	...
	*/
	Sources []Accesscontextmanager_ServicePerimeterStatusEgressPolicyEgressFromSource `json:"sources,omitempty" yaml:"sources,omitempty"`
}
