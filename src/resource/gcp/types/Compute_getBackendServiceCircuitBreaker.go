...
type Compute_getBackendServiceCircuitBreaker struct {
	/*
	...
	*/
	...
	ConnectTimeouts []Compute_getBackendServiceCircuitBreakerConnectTimeout `json:"connectTimeouts,omitempty" yaml:"connectTimeouts,omitempty"`
