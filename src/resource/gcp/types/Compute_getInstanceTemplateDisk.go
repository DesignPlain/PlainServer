...
type Compute_getInstanceTemplateDisk struct {
	/*
	...
	*/
	...
	DiskEncryptionKeys []Compute_getInstanceTemplateDiskDiskEncryptionKey `json:"diskEncryptionKeys,omitempty" yaml:"diskEncryptionKeys,omitempty"`
	...
	*/
	...
	SourceSnapshotEncryptionKeys []Compute_getInstanceTemplateDiskSourceSnapshotEncryptionKey `json:"sourceSnapshotEncryptionKeys,omitempty" yaml:"sourceSnapshotEncryptionKeys,omitempty"`
	...
	*/
	SourceImageEncryptionKeys []Compute_getInstanceTemplateDiskSourceImageEncryptionKey `json:"sourceImageEncryptionKeys,omitempty" yaml:"sourceImageEncryptionKeys,omitempty"`
