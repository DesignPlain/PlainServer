...
type Accesscontextmanager_ServicePerimetersServicePerimeterSpecEgressPolicyEgressFrom struct {
	/*
	...
	*/
	Sources []Accesscontextmanager_ServicePerimetersServicePerimeterSpecEgressPolicyEgressFromSource `json:"sources,omitempty" yaml:"sources,omitempty"`
}
