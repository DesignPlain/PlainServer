...
type Osconfig_OsPolicyAssignmentOsPolicyResourceGroupResourceExecValidate struct {
	/*
	...
	*/
	...
	/*
	   ...
	   documented below.
	*/
	File Osconfig_OsPolicyAssignmentOsPolicyResourceGroupResourceExecValidateFile `json:"file,omitempty" yaml:"file,omitempty"`
