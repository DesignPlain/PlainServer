...
type Container_AwsNodePoolConfig struct {
	...
	// Optional. When specified, the node pool will provision Spot instances from the set of spot_config.instance_ This field is mutually exclusive with `instance_type`
