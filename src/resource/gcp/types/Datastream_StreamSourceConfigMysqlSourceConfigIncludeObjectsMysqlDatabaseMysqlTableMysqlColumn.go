...
type Datastream_StreamSourceConfigMysqlSourceConfigIncludeObjectsMysqlDatabaseMysqlTableMysqlColumn struct {
	...
	/*
	   ...
	   https://dev.mysql.com/doc/refman/8.0/en/data-html
	*/
