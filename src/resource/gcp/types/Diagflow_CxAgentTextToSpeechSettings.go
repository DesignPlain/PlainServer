...
type Diagflow_CxAgentTextToSpeechSettings struct {
	/*
	...
	*/
	SynthesizeSpeechConfigs string `json:"synthesizeSpeechConfigs,omitempty" yaml:"synthesizeSpeechConfigs,omitempty"`
}
