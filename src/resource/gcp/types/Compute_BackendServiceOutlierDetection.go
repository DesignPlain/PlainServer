...
type Compute_BackendServiceOutlierDetection struct {
	/*
	...
	*/
	BaseEjectionTime Compute_BackendServiceOutlierDetectionBaseEjectionTime `json:"baseEjectionTime,omitempty" yaml:"baseEjectionTime,omitempty"`
	...
	*/
	...
	/*
	   ...
	   Structure is documented below.
	*/
	Interval Compute_BackendServiceOutlierDetectionInterval `json:"interval,omitempty" yaml:"interval,omitempty"`
}
