...
type Osconfig_PatchDeploymentPatchConfigPostStepLinuxExecStepConfig struct {
	...
	*/
	GcsObject Osconfig_PatchDeploymentPatchConfigPostStepLinuxExecStepConfigGcsObject `json:"gcsObject,omitempty" yaml:"gcsObject,omitempty"`
