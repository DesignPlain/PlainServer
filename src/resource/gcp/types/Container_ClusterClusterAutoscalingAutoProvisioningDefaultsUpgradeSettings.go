...
type Container_ClusterClusterAutoscalingAutoProvisioningDefaultsUpgradeSettings struct {
	...
	BlueGreenSettings Container_ClusterClusterAutoscalingAutoProvisioningDefaultsUpgradeSettingsBlueGreenSettings `json:"blueGreenSettings,omitempty" yaml:"blueGreenSettings,omitempty"`
