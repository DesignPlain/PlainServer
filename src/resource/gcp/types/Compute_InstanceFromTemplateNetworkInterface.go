...
type Compute_InstanceFromTemplateNetworkInterface struct {
	...
	AccessConfigs []Compute_InstanceFromTemplateNetworkInterfaceAccessConfig `json:"accessConfigs,omitempty" yaml:"accessConfigs,omitempty"`

	// An array of alias IP ranges for this network interface.
	AliasIpRanges []Compute_InstanceFromTemplateNetworkInterfaceAliasIpRange `json:"aliasIpRanges,omitempty" yaml:"aliasIpRanges,omitempty"`
	...
	*/
	...
	Ipv6AccessConfigs []Compute_InstanceFromTemplateNetworkInterfaceIpv6AccessConfig `json:"ipv6AccessConfigs,omitempty" yaml:"ipv6AccessConfigs,omitempty"`
