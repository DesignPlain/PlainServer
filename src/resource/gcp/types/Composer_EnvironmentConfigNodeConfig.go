...
type Composer_EnvironmentConfigNodeConfig struct {
	...
	IpAllocationPolicy Composer_EnvironmentConfigNodeConfigIpAllocationPolicy `json:"ipAllocationPolicy,omitempty" yaml:"ipAllocationPolicy,omitempty"`
