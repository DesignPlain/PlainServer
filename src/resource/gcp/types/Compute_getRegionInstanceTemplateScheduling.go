...
type Compute_getRegionInstanceTemplateScheduling struct {
	/*
	...
	*/
	NodeAffinities []Compute_getRegionInstanceTemplateSchedulingNodeAffinity `json:"nodeAffinities,omitempty" yaml:"nodeAffinities,omitempty"`
	...
	*/
	...
	/*
	   Specifies the maximum amount of time a Local Ssd Vm should wait while
	     ...
	     hour.
	*/
	LocalSsdRecoveryTimeouts []Compute_getRegionInstanceTemplateSchedulingLocalSsdRecoveryTimeout `json:"localSsdRecoveryTimeouts,omitempty" yaml:"localSsdRecoveryTimeouts,omitempty"`
	...
	MaxRunDurations []Compute_getRegionInstanceTemplateSchedulingMaxRunDuration `json:"maxRunDurations,omitempty" yaml:"maxRunDurations,omitempty"`
