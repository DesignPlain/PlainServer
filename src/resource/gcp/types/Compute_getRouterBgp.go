...
type Compute_getRouterBgp struct {
	...
	*/
	AdvertisedIpRanges []Compute_getRouterBgpAdvertisedIpRange `json:"advertisedIpRanges,omitempty" yaml:"advertisedIpRanges,omitempty"`
