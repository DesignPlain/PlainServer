...
type Compute_RegionUrlMapDefaultRouteActionRetryPolicy struct {
	...
	*/
	PerTryTimeout Compute_RegionUrlMapDefaultRouteActionRetryPolicyPerTryTimeout `json:"perTryTimeout,omitempty" yaml:"perTryTimeout,omitempty"`
