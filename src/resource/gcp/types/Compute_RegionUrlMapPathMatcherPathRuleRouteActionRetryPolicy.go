...
type Compute_RegionUrlMapPathMatcherPathRuleRouteActionRetryPolicy struct {
	/*
	...
	*/
	PerTryTimeout Compute_RegionUrlMapPathMatcherPathRuleRouteActionRetryPolicyPerTryTimeout `json:"perTryTimeout,omitempty" yaml:"perTryTimeout,omitempty"`
}
