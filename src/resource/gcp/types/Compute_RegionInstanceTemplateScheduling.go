...
type Compute_RegionInstanceTemplateScheduling struct {
	/*
	...
	*/
	NodeAffinities []Compute_RegionInstanceTemplateSchedulingNodeAffinity `json:"nodeAffinities,omitempty" yaml:"nodeAffinities,omitempty"`
	...
	*/
	...
	/*
	   Specifies the maximum amount of time a Local Ssd Vm should wait while
	     ...
	     hour.
	*/
	LocalSsdRecoveryTimeouts []Compute_RegionInstanceTemplateSchedulingLocalSsdRecoveryTimeout `json:"localSsdRecoveryTimeouts,omitempty" yaml:"localSsdRecoveryTimeouts,omitempty"`
	...
	MaxRunDuration Compute_RegionInstanceTemplateSchedulingMaxRunDuration `json:"maxRunDuration,omitempty" yaml:"maxRunDuration,omitempty"`
