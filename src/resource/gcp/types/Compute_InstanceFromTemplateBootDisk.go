...
type Compute_InstanceFromTemplateBootDisk struct {
	...
	InitializeParams Compute_InstanceFromTemplateBootDiskInitializeParams `json:"initializeParams,omitempty" yaml:"initializeParams,omitempty"`
}
