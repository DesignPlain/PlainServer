...
type Appengine_StandardAppVersionHandler struct {
	/*
	...
	*/
	Script Appengine_StandardAppVersionHandlerScript `json:"script,omitempty" yaml:"script,omitempty"`
	...
	*/
	...
	/*
	   ...
	   Structure is documented below.
	*/
	StaticFiles Appengine_StandardAppVersionHandlerStaticFiles `json:"staticFiles,omitempty" yaml:"staticFiles,omitempty"`
}
