...
type Compute_RegionNetworkFirewallPolicyRuleMatch struct {
	...
	*/
	...
	Layer4Configs []Compute_RegionNetworkFirewallPolicyRuleMatchLayer4Config `json:"layer4Configs,omitempty" yaml:"layer4Configs,omitempty"`
	...
	SrcSecureTags []Compute_RegionNetworkFirewallPolicyRuleMatchSrcSecureTag `json:"srcSecureTags,omitempty" yaml:"srcSecureTags,omitempty"`
