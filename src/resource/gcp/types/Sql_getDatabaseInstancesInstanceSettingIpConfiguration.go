...
type Sql_getDatabaseInstancesInstanceSettingIpConfiguration struct {
	...
	PscConfigs []Sql_getDatabaseInstancesInstanceSettingIpConfigurationPscConfig `json:"pscConfigs,omitempty" yaml:"pscConfigs,omitempty"`
	...
	//
	AuthorizedNetworks []Sql_getDatabaseInstancesInstanceSettingIpConfigurationAuthorizedNetwork `json:"authorizedNetworks,omitempty" yaml:"authorizedNetworks,omitempty"`
}
