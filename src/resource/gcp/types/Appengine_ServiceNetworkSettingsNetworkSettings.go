...
type Appengine_ServiceNetworkSettingsNetworkSettings struct {
	/*
	   ...
	   - - -
	*/
	IngressTrafficAllowed string `json:"ingressTrafficAllowed,omitempty" yaml:"ingressTrafficAllowed,omitempty"`
}
