...
type Compute_RegionInstanceTemplateNetworkInterface struct {
	...
	*/
	Ipv6AccessConfigs []Compute_RegionInstanceTemplateNetworkInterfaceIpv6AccessConfig `json:"ipv6AccessConfigs,omitempty" yaml:"ipv6AccessConfigs,omitempty"`
	...
	*/
	...
	//
	AccessConfigs []Compute_RegionInstanceTemplateNetworkInterfaceAccessConfig `json:"accessConfigs,omitempty" yaml:"accessConfigs,omitempty"`
	...
	*/
	AliasIpRanges []Compute_RegionInstanceTemplateNetworkInterfaceAliasIpRange `json:"aliasIpRanges,omitempty" yaml:"aliasIpRanges,omitempty"`
