...
type ForwardingRule struct {
	...
	*/
	ServiceDirectoryRegistrations types.Compute_ForwardingRuleServiceDirectoryRegistrations `json:"serviceDirectoryRegistrations,omitempty" yaml:"serviceDirectoryRegistrations,omitempty"`
