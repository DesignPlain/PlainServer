...
type BillingAccountBucketConfig struct {
	...
	*/
	CmekSettings types.Logging_BillingAccountBucketConfigCmekSettings `json:"cmekSettings,omitempty" yaml:"cmekSettings,omitempty"`

	// Describes this bucket.
	Description string `json:"description,omitempty" yaml:"description,omitempty"`

	// A list of indexed fields and related configuration data. Structure is documented below.
	IndexConfigs []types.Logging_BillingAccountBucketConfigIndexConfig `json:"indexConfigs,omitempty" yaml:"indexConfigs,omitempty"`
