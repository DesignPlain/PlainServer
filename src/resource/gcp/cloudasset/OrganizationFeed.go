...
type OrganizationFeed struct {
	...
	*/
	FeedOutputConfig types.Cloudasset_OrganizationFeedFeedOutputConfig `json:"feedOutputConfig,omitempty" yaml:"feedOutputConfig,omitempty"`
	...
	*/
	...
	/*
	   ...
	   Structure is documented below.
	*/
	Condition types.Cloudasset_OrganizationFeedCondition `json:"condition,omitempty" yaml:"condition,omitempty"`
