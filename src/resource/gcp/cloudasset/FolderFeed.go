...
type FolderFeed struct {
	...
	*/
	FeedOutputConfig types.Cloudasset_FolderFeedFeedOutputConfig `json:"feedOutputConfig,omitempty" yaml:"feedOutputConfig,omitempty"`
	...
	*/
	...
	/*
	   ...
	   Structure is documented below.
	*/
	Condition types.Cloudasset_FolderFeedCondition `json:"condition,omitempty" yaml:"condition,omitempty"`
}
