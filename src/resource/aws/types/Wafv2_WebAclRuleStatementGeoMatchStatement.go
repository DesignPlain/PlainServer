...
type Wafv2_WebAclRuleStatementGeoMatchStatement struct {
	...
	ForwardedIpConfig Wafv2_WebAclRuleStatementGeoMatchStatementForwardedIpConfig `json:"forwardedIpConfig,omitempty" yaml:"forwardedIpConfig,omitempty"`
}
