...
type Ec2_InstanceCapacityReservationSpecification struct {
	...
	*/
	CapacityReservationTarget Ec2_InstanceCapacityReservationSpecificationCapacityReservationTarget `json:"capacityReservationTarget,omitempty" yaml:"capacityReservationTarget,omitempty"`
}
