...
type Emr_InstanceFleetInstanceTypeConfig struct {
	...
	Configurations []Emr_InstanceFleetInstanceTypeConfigConfiguration `json:"configurations,omitempty" yaml:"configurations,omitempty"`

	// Configuration block(s) for EBS volumes attached to each instance in the instance group. Detailed below.
	EbsConfigs []Emr_InstanceFleetInstanceTypeConfigEbsConfig `json:"ebsConfigs,omitempty" yaml:"ebsConfigs,omitempty"`
