...
type Kinesis_FirehoseDeliveryStreamRedshiftConfigurationS3Configuration struct {
	...
	*/
	...
	CloudwatchLoggingOptions Kinesis_FirehoseDeliveryStreamRedshiftConfigurationS3ConfigurationCloudwatchLoggingOptions `json:"cloudwatchLoggingOptions,omitempty" yaml:"cloudwatchLoggingOptions,omitempty"`
