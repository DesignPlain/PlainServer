...
type Wafv2_WebAclRuleStatementSizeConstraintStatementFieldToMatchJsonBody struct {
	...
	MatchPattern Wafv2_WebAclRuleStatementSizeConstraintStatementFieldToMatchJsonBodyMatchPattern `json:"matchPattern,omitempty" yaml:"matchPattern,omitempty"`
