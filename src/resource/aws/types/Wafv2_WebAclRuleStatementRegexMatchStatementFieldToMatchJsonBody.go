...
type Wafv2_WebAclRuleStatementRegexMatchStatementFieldToMatchJsonBody struct {
	...
	MatchPattern Wafv2_WebAclRuleStatementRegexMatchStatementFieldToMatchJsonBodyMatchPattern `json:"matchPattern,omitempty" yaml:"matchPattern,omitempty"`
