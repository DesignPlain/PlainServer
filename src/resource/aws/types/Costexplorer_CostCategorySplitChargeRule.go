...
type Costexplorer_CostCategorySplitChargeRule struct {
	...
	Parameters []Costexplorer_CostCategorySplitChargeRuleParameter `json:"parameters,omitempty" yaml:"parameters,omitempty"`
