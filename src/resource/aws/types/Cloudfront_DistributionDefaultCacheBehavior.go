...
type Cloudfront_DistributionDefaultCacheBehavior struct {
	...
	ForwardedValues Cloudfront_DistributionDefaultCacheBehaviorForwardedValues `json:"forwardedValues,omitempty" yaml:"forwardedValues,omitempty"`
	...
	FunctionAssociations []Cloudfront_DistributionDefaultCacheBehaviorFunctionAssociation `json:"functionAssociations,omitempty" yaml:"functionAssociations,omitempty"`
	...
	LambdaFunctionAssociations []Cloudfront_DistributionDefaultCacheBehaviorLambdaFunctionAssociation `json:"lambdaFunctionAssociations,omitempty" yaml:"lambdaFunctionAssociations,omitempty"`
