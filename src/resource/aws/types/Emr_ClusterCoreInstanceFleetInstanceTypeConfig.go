...
type Emr_ClusterCoreInstanceFleetInstanceTypeConfig struct {
	...
	Configurations []Emr_ClusterCoreInstanceFleetInstanceTypeConfigConfiguration `json:"configurations,omitempty" yaml:"configurations,omitempty"`

	// Configuration block(s) for EBS volumes attached to each instance in the instance group. Detailed below.
	EbsConfigs []Emr_ClusterCoreInstanceFleetInstanceTypeConfigEbsConfig `json:"ebsConfigs,omitempty" yaml:"ebsConfigs,omitempty"`
