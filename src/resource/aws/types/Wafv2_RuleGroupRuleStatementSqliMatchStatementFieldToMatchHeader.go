...
type Wafv2_RuleGroupRuleStatementSqliMatchStatementFieldToMatchHeader struct {
	...
	MatchPattern Wafv2_RuleGroupRuleStatementSqliMatchStatementFieldToMatchHeaderMatchPattern `json:"matchPattern,omitempty" yaml:"matchPattern,omitempty"`
