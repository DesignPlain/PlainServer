...
type Networkmanager_getCoreNetworkPolicyDocumentCoreNetworkConfiguration struct {
	...
	VpnEcmpSupport bool `json:"vpnEcmpSupport,omitempty" yaml:"vpnEcmpSupport,omitempty"`
	...
	AsnRanges []string `json:"asnRanges,omitempty" yaml:"asnRanges,omitempty"`

	// A block value of AWS Region locations where you're creating Core Network Edges. Detailed below.
	EdgeLocations []Networkmanager_getCoreNetworkPolicyDocumentCoreNetworkConfigurationEdgeLocation `json:"edgeLocations,omitempty" yaml:"edgeLocations,omitempty"`
}
