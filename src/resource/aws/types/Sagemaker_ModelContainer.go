...
type Sagemaker_ModelContainer struct {
	...
	*/
	...
	ImageConfig Sagemaker_ModelContainerImageConfig `json:"imageConfig,omitempty" yaml:"imageConfig,omitempty"`
	...
	ModelDataSource Sagemaker_ModelContainerModelDataSource `json:"modelDataSource,omitempty" yaml:"modelDataSource,omitempty"`
