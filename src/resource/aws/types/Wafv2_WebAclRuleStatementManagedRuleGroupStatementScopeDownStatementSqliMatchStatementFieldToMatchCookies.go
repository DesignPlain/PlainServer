...
type Wafv2_WebAclRuleStatementManagedRuleGroupStatementScopeDownStatementSqliMatchStatementFieldToMatchCookies struct {
	...
	MatchPatterns []Wafv2_WebAclRuleStatementManagedRuleGroupStatementScopeDownStatementSqliMatchStatementFieldToMatchCookiesMatchPattern `json:"matchPatterns,omitempty" yaml:"matchPatterns,omitempty"`
