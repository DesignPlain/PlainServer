...
type Cloudfront_DistributionOrderedCacheBehaviorForwardedValues struct {
	...
	Cookies Cloudfront_DistributionOrderedCacheBehaviorForwardedValuesCookies `json:"cookies,omitempty" yaml:"cookies,omitempty"`
