...
type Lex_V2modelsIntentConfirmationSettingDeclinationConditional struct {
	...
	ConditionalBranches []Lex_V2modelsIntentConfirmationSettingDeclinationConditionalConditionalBranch `json:"conditionalBranches,omitempty" yaml:"conditionalBranches,omitempty"`
	...
	DefaultBranch Lex_V2modelsIntentConfirmationSettingDeclinationConditionalDefaultBranch `json:"defaultBranch,omitempty" yaml:"defaultBranch,omitempty"`
}
