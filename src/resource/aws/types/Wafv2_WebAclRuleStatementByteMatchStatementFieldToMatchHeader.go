...
type Wafv2_WebAclRuleStatementByteMatchStatementFieldToMatchHeader struct {
	...
	MatchPattern Wafv2_WebAclRuleStatementByteMatchStatementFieldToMatchHeaderMatchPattern `json:"matchPattern,omitempty" yaml:"matchPattern,omitempty"`
