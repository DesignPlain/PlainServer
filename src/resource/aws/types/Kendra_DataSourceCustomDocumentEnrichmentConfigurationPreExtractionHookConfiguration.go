...
type Kendra_DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfiguration struct {
	...
	InvocationCondition Kendra_DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfigurationInvocationCondition `json:"invocationCondition,omitempty" yaml:"invocationCondition,omitempty"`
