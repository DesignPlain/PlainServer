...
type Kinesis_FirehoseDeliveryStreamSplunkConfigurationProcessingConfigurationProcessor struct {
	// Specifies the processor parameters as multiple blocks. See `parameters` block below for details.
	Parameters []Kinesis_FirehoseDeliveryStreamSplunkConfigurationProcessingConfigurationProcessorParameter `json:"parameters,omitempty" yaml:"parameters,omitempty"`
