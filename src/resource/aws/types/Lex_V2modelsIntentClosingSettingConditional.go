...
type Lex_V2modelsIntentClosingSettingConditional struct {
	...
	ConditionalBranches []Lex_V2modelsIntentClosingSettingConditionalConditionalBranch `json:"conditionalBranches,omitempty" yaml:"conditionalBranches,omitempty"`
	...
	DefaultBranch Lex_V2modelsIntentClosingSettingConditionalDefaultBranch `json:"defaultBranch,omitempty" yaml:"defaultBranch,omitempty"`
}
